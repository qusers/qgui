...
class AddSequenceRestraints(Toplevel):
    ...
    def dialog_box(self):
        ...
        self.restraint_list.config(font = tkinter.font.Font(family="Courier", size=12))
...
class AddAtomRestraints(Toplevel):
    ...
    def dialog_box(self):
        ...
        if self.app.fep:
            states_label = Label(left_frame, text= "\N{GREEK SMALL LETTER LAMDA}-state (0=all)", bg=self.main_color)
...
class AddWallRestraints(Toplevel):
    ...
    def dialog_box(self):
        ...
        alpha = Label(left_frame, text = "\N{GREEK SMALL LETTER ALPHA}", bg=self.main_color)
